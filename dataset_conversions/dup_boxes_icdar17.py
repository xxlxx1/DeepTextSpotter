...
if __name__ == '__main__':
  ...
  list_file = open('E:\\icdar_2017\\result\\test_icdar2017.txt', 'w')
  
  for image_name in sorted(images[:30]):
  ...
  np.savez('E:\\icdar_2017\\result\\voc_boxes.npz', box_list = boxes_all)
